 ...
 *
 * MISRA-C:2004 justification: the violations of MISRA Rules connected to the file cannot be eliminated, 
 * because it defines the Special Function Registers of C Language Extensions of Cx51 Compiler.
 *
...
REG_TYPE REG_DC0MD       = 0x94;        /*                                        */
REG_TYPE REG_TMR3H       = 0x95;        /*                                        */
REG_TYPE REG_CRC0FLIP    = 0x95;        /*                                        */
...
REG_TYPE REG_P0DRV       = 0xA4;        /*                                        */
REG_TYPE REG_P1MDOUT     = 0xA5;        /*                                        */
REG_TYPE REG_P1DRV       = 0xA5;        /*                                        */
REG_TYPE REG_P2MDOUT     = 0xA6;        /*                                        */
REG_TYPE REG_P2DRV       = 0xA6;        /*                                        */
...
REG_TYPE REG_SPI1CN      = 0xB0;        /* Internal Fine Oscillator Calibration   */
...
REG_TYPE REG_IREF0CF     = 0xB9;        /*                                        */
REG_TYPE REG_ADC0AC      = 0xBA;        /*                                        */
REG_TYPE REG_ADC0PWR     = 0xBA;        /*                                        */
...
REG_TYPE REG_PCA0CPL5    = 0xD2;        /* PCA Capture Module 5 Low Byte          */
REG_TYPE REG_PCA0CPH5    = 0xD3;        /* PCA Capture Module 5 High Byte         */
...
REG_TYPE REG_FLWR        = 0xE5;        /*                                        */
REG_TYPE REG_EIE1        = 0xE6;        /*                                        */
REG_TYPE REG_EIE2        = 0xE7;        /*                                        */
REG_TYPE REG_ADC0CN      = 0xE8;        /*                                        */
REG_TYPE REG_PCA0CPL1    = 0xE9;        /* PCA Capture Module 1 Low Byte          */
REG_TYPE REG_PCA0CPH1    = 0xEA;        /* PCA Capture Module 1 High Byte         */
REG_TYPE REG_PCA0CPL2    = 0xEB;        /* PCA Capture Module 2 Low Byte          */
REG_TYPE REG_PCA0CPH2    = 0xEC;        /* PCA Capture Module 2 High Byte         */
REG_TYPE REG_PCA0CPL3    = 0xED;        /* PCA Capture Module 3 Low Byte          */
REG_TYPE REG_PCA0CPH3    = 0xEE;        /* PCA Capture Module 3 High Byte         */
...
REG_TYPE REG_PCA0CPL0    = 0xFB;        /* PCA Capture Module 0 Low Byte          */
REG_TYPE REG_PCA0CPH0    = 0xFC;        /* PCA Capture Module 0 High Byte         */
REG_TYPE REG_PCA0CPL4    = 0xFD;        /* PCA Capture Module 4 Low Byte          */
REG_TYPE REG_PCA0CPH4    = 0xFE;        /* PCA Capture Module 4 High Byte         */
